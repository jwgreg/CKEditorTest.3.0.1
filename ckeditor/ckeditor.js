...
(function() {
                ...
                domReady: function() {
                    ...
                    return function(b) {
                        ...
                        if (1 == c.length)
                            ...
                            b = !1;
                            try { b = !window.frameElement } catch (t) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, g, h, l) {
                function q(a, f, z, l) { a = { name: b, sender: this, editor: a, data: f, listenerData: h, stop: z, cancel: l, removeListener: t };
                    return !1 === d.call(g, a) ? !1 : a.data }

                function t() { z.removeListener(b, d) }
                var f = a.call(this, b);
                if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    ...
                    for (var A = f.length - 1; 0 <= A; A--)
                        if (f[A].priority <= l) return f.splice(A + 1, 0, q), { removeListener: t };
                    f.unshift(q) }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getAscendant: function(a, d) {
            var b = this.$,
                c, e;
            d || (b = b.parentNode); "function" == typeof a ? (e = !0, c = a) : (e = !1, c = function(b) { b = "string" == typeof b.nodeName ? b.nodeName.toLowerCase() : "";
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            ...
            if (k && n.type == CKEDITOR.NODE_TEXT && p.equals(n)) p = a.document.createText(p.substring(D, r)), c.append(p);
                ...
                for (P = I; P <= J; P++)
                    ...
                    else { P != J || c.equals(w[P]) && J < G ? b && (K = O.append(c.clone(0, e))) : B ? m(c, O, !1, q) : S && O.append(a.document.createText(c.substring(0, r)));
                        if (P > fa)
                            for (; W;) W = m(W, O, !0);
                        O = K }
                k || h()
        ...
        function e(a) {
            return function() {
                var b;
                return this[a ?
                    "getPreviousNode" : "getNextNode"](function(a) {!b && t(a) && (b = a);
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function() {
                ...
                return function(b) {
                    ...
                    b && (a(d), c || a(e));
                    return { start: d.container.getAddress(b), end: c ? null : e.container.getAddress(b), startOffset: d.offset, endOffset: e.offset, normalized: b, collapsed: c, is2: !0 }
                }
            }(),
            moveToBookmark: function(a) {
                if (a.is2) {
                    ...
                    a = a.endOffset;
                    this.setStart(b, c);
                    d ? this.setEnd(d, a) : this.collapse(!0) } else b = (c = a.serializable) ? this.document.getById(a.startNode) :
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                                        ...
                                        if (D && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(F)) p = null;
                                                ...
                                                for (var B = p.$.getElementsByTagName("*"), t = 0, q; q = B[t++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[q.nodeName.toLowerCase()]) { p = null;
                                                        break }
                                            p && (r = !!F.length)
                                        } else p = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var M, S, w = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            H = null,
                            I = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (H) {
                                        if (H.equals(a)) { H = null;
                                            return } } else H = a;
                                else if (H) return;
                                var b = w(a);
                                b || (M = a);
                ...
                for (this._.nextNode = null; y;) {
                    ...
                    if (x) y.type == CKEDITOR.NODE_TEXT && e.test(y.getText()) && (x = 0);
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == y.getAttribute("contenteditable")) { d = y;
                            b(this, a, d);
                            break } else if (y.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) {
                            if ("br" == p) x = 1;
                            else if (!h && !y.getChildCount() && "hr" != p) { d = y;
                                A = y.equals(m);
                                break }
                            h && (h.setEndAt(y, CKEDITOR.POSITION_BEFORE_START), "br" != p && (this._.nextNode = y));
                            E = 1 } else {
                            if (y.getFirst()) { h || (h = this.range.clone(), h.setStartAt(y, CKEDITOR.POSITION_BEFORE_START));
                                y = y.getFirst();
                                continue }
                            x = 1 }
                    }
                    ...
                    A = (!E || x) && y.equals(m);
                    if (h && !E)
                        for (; !y.getNext(l) && !A;) { p = y.getParent();
                            if (p.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) { E = 1;
                                x = 0;
                                A || p.equals(m);
    ...
    (function() {
        ...
        function f(a) {
            var b, c, d, k, p = {},
                e = 1;
            for (a = T(a); b = a.match(H);)(c = b[2]) ? (d = z(c, "styles"), k = z(c, "attrs"), c = z(c, "classes")) : d = k = c = null, p["$" + e++] = { elements: b[1], classes: c, styles: d, attributes: k }, a = a.slice(b[0].length);
            return p }
        ...
        function u(a, b, k, e) {
            ...
            if (e.doFilter) {
                a: {
                    ...
                    g = e.skipRequired;
                    var D = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 },
                        w, h;
                    if (a || r) { A(b);
                        if (f)
                            for (w = 0, h = f.length; w < h; ++w)
                                if (!1 === c(f[w], b, D)) { a = null;
                                    break a }
                        if (x)
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    ...
                    O.length && (f.style = O.sort().join("; ")) } else I && (f.style = I);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (B = 0; B < x.length; ++B)(a.allClasses || r[x[B]]) && D.push(x[B]);
                    D.length && (f["class"] = D.sort().join(" "));
                    g && D.length < g.split(/\s+/).length && (w = !0) } else g && (f["class"] = g);w && (n = 1);
        ...
        function k(a, b, c) {
            var d = a.name;
            if (B.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
        ...
        function p(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (k = c[d], !(k.check && !a.check(k.check, !1) || k.left && !k.left(b))) { k.right(b, O);
                    break } }
            ...
            for (e in d)
                if ("class" == e)
                    for (c = d[e].split(/\s+/), n = a.classes.join("|"); r = c.pop();) {
                        if (-1 == n.indexOf(r)) return !1 } else if (a.attributes[e] != d[e]) return !1;
            for (p in k)
                if (a.styles[p] !=
                    k[p]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
                ...
                if (!this.disabled && a) {
                    ...
                    for (k = 0; k < a.length; ++k) {
                        ...
                        for (p = 0; p < b.length; ++p) n = b[p], "string" == typeof n ? (n = n.split(/\s*:\s*/), f = n[0], x = null, m = n[1]) : (f = n.check, x = n.left, m = n.right), e || (e = n, e = e.element ? e.element : f ? f.match(/^([a-z0-9]+)/i)[0] :
                            e.left.getDefinition().element), x instanceof CKEDITOR.style && (x = r(x)), c.push({ check: f == e ? null : f, left: x, right: "string" == typeof m ? F(m) : m });
                        b = e;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    k = d
                } else d = a.getDefinition(), k = d.styles, n = d.attributes || {}, k ? (k = L(k), n.style = CKEDITOR.tools.writeCssText(k, !0)) : k = {}, k = { name: d.element, attributes: n, classes: n["class"] ? n["class"].split(/\s+/) : [], styles: k, children: [] };
        ...
        var S = { styles: 1, attributes: 1, classes: 1 },
            w = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" },
        ...
        return {
            load: function(b, c, e, g) {
                ...
                var l = b.length,
                    q = [],
                    t = [],
                    f = function(a) { c && (h ? c.call(e, a) : c.call(e, q, t)) };
                if (0 === l) f(!0);
                else {
                    var z = function(a, b) {
                            (b ? q : t).push(a);
    ...
    (function() {
        ...
        function q(a) { CKEDITOR.skin.loadPart("editor", function() { t(a) }) }
        ...
        function z(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    if (l && (w = l.match(p)))
                        for (; l = w.pop();) CKEDITOR.error("editor-plugin-required", { plugin: l.replace(",", ""), requiredBy: f });
            ...
            function(g, h, l) {
                ...
                C.onTagOpen = function(e, n, f, r) {
                    ...
                    if (a(n)) y.push(n);
                        ...
                        if ("pre" == e) k = !0;
                            ...
                            if ("br" == e && k) { v.add(new CKEDITOR.htmlParser.text("\n"));
                                return } "textarea" == e && (x = !0) }
                        if ("br" == e) E.push(n);
                        else {
                ...
                C.onText = function(a) {
                    ...
                    if (!x && !f["#"] && b in d) C.onTagOpen(e[b] || ""), C.onText(a);
                        ...
                        v.add(a) } };
                C.onCDATA =
                    function(a) { v.add(new CKEDITOR.htmlParser.cdata(a)) };
                C.onComment = function(a) { t();
                    q();
    ...
    (function() {
        ...
        function m(a, b) {
            ...
            for (var n = 0; n < d.length; n++) a = a.replace(d[n], function(a) { a = a.replace(e, function(a, b, d) {
                    return c[d] });
        ...
        CKEDITOR.editor.prototype.setMode = function(a, b) {
            ...
            if (a != d.mode && h && h[a]) {
                ...
                if (d.mode) {
                    ...
                    d._.previousModeData = q = d.getData(1); "source" == d.mode && h == q && (d.fire("lockSnapshot", { forceUpdate: !0 }), t = 1);
            ...
            proto: {
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) { b.data.getKeystroke() in h && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
        ...
        var f = CKEDITOR.dom.walker.whitespaces(!0),
            ...
            m = function() {
                ...
                return function(m, w, H, I) {
                    ...
                    if (!I.checkReadOnly()) {
                        ...
                        m = { type: w, dontFilter: J, editable: m, editor: G, range: I, blockLimit: L, mergeCandidates: [], zombies: [] };
                        w = m.range;
                        I = m.mergeCandidates;
                        var K, u;
                        ...
                        if (K = H) {
                            ...
                            if (/^\s+|\s+$/.test(H) && "span" in CKEDITOR.dtd[u]) {
                                ...
                                H = A + H + A }
                            H = m.editor.dataProcessor.toHtml(H, { context: null, fixForBody: !1, protectedWhitespaces: !!A, dontFilter: m.dontFilter, filter: m.editor.activeFilter, enterMode: m.editor.activeEnterMode });
                            u = K.document.createElement("body");
                            u.setHtml(H);
                            A && (u.getFirst().remove(), u.getLast().remove());
                            if ((A = K.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: {
                                var z;
                                if (1 == u.getChildCount() && a(z = u.getFirst()) && z.is(t) && !z.hasAttribute("contenteditable")) { A = z.getElementsByTag("*");
                                    K = 0;
                                    for (I = A.count(); K < I; K++)
                        ...
                        if (K) {
                            ...
                            for (g(w, z); I < w.length; I++) {
                                L = w[I];
                                if (v = L.isLineBreak) { v = z;
                                    R = u;
                                    var U = void 0,
                                        ba = void 0;
                                    L.hasBlockSibling ? v = 1 : (U = v.startContainer.getAscendant(B.$block, 1)) && U.is({ div: 1, p: 1 }) ? (ba = U.getPosition(R), ba == CKEDITOR.POSITION_IDENTICAL || ba == CKEDITOR.POSITION_CONTAINS ? v = 0 : (R = v.splitElement(U), v.moveToPosition(R, CKEDITOR.POSITION_AFTER_START), v = 1)) : v = 0 }
                                if (v) H = 0 < I;
                                else {
                                    v =
                                        z.startPath();
                        ...
                        if (!m.dontMoveCaret) {
                            for (N = e(C); N && a(N) && !N.is(B.$empty);) {
                                if (N.isBlockBoundary()) C.moveToPosition(N, CKEDITOR.POSITION_BEFORE_END);
                                    ...
                                    if (f(N) && N.getHtml().match(/(\s|&nbsp;)$/g)) { Q = null;
                                        break }
                                    Q = C.clone();
            ...
            y = function() {
                ...
                return function(d) {
                    ...
                    f || (f = e);
                    f.is("table") ? (d.setStartAt(f, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), f.remove()) : (f.is({ tbody: 1, thead: 1, tfoot: 1 }) && (f = b(f, "tr", h)), f.is("tr") && (f = b(f, f.getParent().is("thead") ? "th" : "td", h)), (e = f.getBogus()) && e.remove(), d.moveToPosition(f, h ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END))
                }
            }(),
            E = {
                eol: {
                ...
                tree: {
                    rebuild: function(a, b) {
                        ...
                        if (e.blockLimit.is({ tr: 1, table: 1 })) {
                            ...
                            h = function(a) {
                                return !a.equals(g) } } else if (e.block &&
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                function b() { H = new CKEDITOR.dom.selection(e.getSelection());
                    H.lock() }
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus", function(a) { a.removeListener();
                    0 !== w && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(), a.moveToElementEditStart(g), a.select()) }, null, null, -2);
                ...
                g.attachListener(g, "mousedown", function() { w = 0 });
                if (CKEDITOR.env.ie || m) E ? g.attachListener(g, "beforedeactivate", b, null, null, -1) : g.attachListener(e, "selectionCheck", b, null, null, -1), g.attachListener(g, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { e.lockSelection(H);
                    w = 1 }, null, null, -1), g.attachListener(g, "mousedown", function() { w = 0 });
                if (CKEDITOR.env.ie && !m) {
                    var I;
                    g.attachListener(g, "mousedown",
                        function(a) { 2 == a.data.$.button && ((a = e.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (I = e.window.getScrollPosition())) });
                ...
                if (m && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    g.attachListener(f.getDocumentElement(), "mouseup", function() { G && d.call(e);
                        G = 0 }) } else g.attachListener(CKEDITOR.env.ie ?
        ...
        CKEDITOR.on("instanceReady", function(a) {
            function b() {
                var a = d.editable();
                if (a && (a = g(a))) {
                    var c = d.document.$.getSelection(); "None" == c.type || c.anchorNode != a.$ && c.focusNode != a.$ || (f = q(c));
                    e = a.getText();
                    a.setText(l(e)) } }
            ...
            CKEDITOR.env.webkit && (d.on("selectionChange", function() {
                    var a = d.editable(),
                        b = g(a);
                    b && (b.getCustomData("ready") ? h(a) : b.setCustomData("ready", 1)) }, null,
        ...
        CKEDITOR.editor.prototype.lockSelection =
            function(a) { a = a || this.getSelection(1);
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = E ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < h;) try { k = f[0 < n ? "previousSibling" : "nextSibling"], k.nodeType == CKEDITOR.NODE_TEXT && (h -= k.nodeValue.length, m = k), f = k } catch (t) {
                    ...
                    if (this.isLocked) {
                        ...
                        if (g) this.fake(g);
                            ...
                            if (E) {
                                ...
                                a = g.collapsed;
                                var t, q, u;
                                if ((c = g.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in x && (!c.is("a") || !c.getText())) try { u = c.$.createControlRange();
                                    u.addElement(c.$);
                                    u.select();
                                    return } catch (w) {}
                                ...
                                for (u = 0; u < a.length; u++) {
                                    if (u < a.length - 1 && (t = a[u], q = a[u + 1], l = t.clone(), l.setStart(t.endContainer,
                                            t.endOffset), l.setEnd(q.startContainer, q.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), g = l.getCommonAncestor(), l = l.getEnclosedNode(), g.isReadOnly() || l && l.isReadOnly()))) { q.setStart(t.startContainer, t.startOffset);
                                        a.splice(u--, 1);
                                        continue }
                                    g = a[u];
                                    ...
                                    try { q.setEnd(g.endContainer.$, g.endOffset) } catch (H) {
            ...
            removeAllRanges: function() {
                if (this.getType() != CKEDITOR.SELECTION_NONE) {
                    var a = this.getNative();
                    try { a && a[E ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
            ...
            if (c.collapsed) f = E(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (r.getPosition(q) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(q)) r = null, l = !0;
                        ...
                        if (v && r.data("cke-bookmark")) { r = r.getNextSourceNode(!0);
                            continue }
            ...
            if (!a.hasAttributes() || b)
                if (CKEDITOR.dtd.$block[a.getName()]) {
                    var c = a.getPrevious(T),
                        d = a.getNext(T);!c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1);!d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br");
        ...
        CKEDITOR.style.prototype = {
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? q : this.type == CKEDITOR.STYLE_OBJECT ? h : null;
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!h && (t = q.getName(),
                        ...
                        if (t = !g && "div" == t) { a: { t = q.getChildren();
                                for (var f = 0, z = t.count(); f < z; f++) {
                                    var A = t.getItem(f);
                                    if (A.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[A.getName()]) { t = !0;
                                        break a } }
                                t = !1 }
                            t = !t }
                        t ? g = q : h = q }
        ...
        init: function(c) {
            function r(p, g, e, h) {
                ...
                c.ui.add(p, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    refresh: function() { c.activeFilter.check(k) || this.setState(CKEDITOR.TRISTATE_DISABLED) },
                    onOpen: function() {
    ...
    (function() {
        ...
        m.prototype = {
            ...
            greedySearch: function() { this.relations = {};
        ...
        n.prototype = {
            ...
            sort: function() {
                var a, d, b, c;
                return function(e, g) { a = this.locations;
                    d = [];
                    for (var f in a)
                        for (var h in a[f])
                            if (b = Math.abs(e - a[f][h]), d.length) {
                                for (c = 0; c < d.length; c++)
                                    if (b < d[c].dist) { d.splice(c, 0, { uid: +f, type: h, dist: b });
                                        break }
            ...
            placeLine: function(a, d) {
                ...
                if (b = this.getStyle(a.uid, a.type)) {
                    for (e in this.visible)
                        if (this.visible[e].getCustomData("hash") !== this.hash) { c = this.visible[e];
                            break }
                    if (!c)
    ...
    (function() {
                ...
                if (b) {
                    ...
                    if (a && a.initOnlyNew) c = this.initOnAll();
                        ...
                        var l = b.find(".cke_widget_wrapper"),
                            c = [];
                        d = 0;
                        for (e = l.count(); d < e; d++) { f = l.getItem(d);
                            if (h = !this.getByElement(f, !0)) { a: { h = Q;
        ...
        function v(a) {
            return { tabindex: -1, contenteditable: "false", "data-cke-widget-wrapper": 1, "data-cke-filter": "off", "class": "cke_widget_wrapper cke_widget_new cke_widget_" + (a ? "inline" : "block") } }
        ...
        function S(a) { a.contextMenu && a.contextMenu.addListener(function(b) {
        ...
        function J(a) {
            ...
            b.on("doubleclick", function(c) {
                ...
                if (b && !g.getNestedEditable(b.wrapper, c.data.element)) return b.fire("doubleclick", { element: c.data.element }) }, null, null, 1)
        }
        ...
        function M(a) {
            function b(c) { a.focused && y(a.focused, "cut" == c.name) }
            var c = a.editor;
        ...
        function I(a) {
            ...
            b.on("dataReady", function() { z(a).commit() });
            b.on("blur", function() {
                var c;
                (c = a.focused) && t(a, c);
            ...
            b.on("toDataFormat", function(b) {
                ...
                b.data.dataValue.forEach(function(c) {
                    ...
                    if ("data-cke-widget-id" in b) {
                        if (b = a.instances[b["data-cke-widget-id"]]) d = c.getFirst(g.isParserWidgetElement), f.push({ wrapper: c, element: d, widget: b, editables: {} }), "1" != d.attributes["data-cke-widget-keep-attr"] && delete d.attributes["data-widget"] } else if ("data-cke-widget-editable" in b) return f[f.length - 1].editables[b["data-cke-widget-editable"]] = c, !1 }, CKEDITOR.NODE_ELEMENT, !0)
            }, null, null, 8);
            b.on("toDataFormat", function(a) {
                if (a.data.downcastingSessionId) { a = c[a.data.downcastingSessionId];
                    for (var b, f, h, l, g, m; b = a.shift();) { f = b.widget;
                        h = b.element;
        ...
        function F(a) {
            ...
            b.on("loadSnapshot", function(c) { /data-cke-widget/.test(c.data) && (d = 1);
            ...
            if (a.draggable) {
                ...
                c ? d = c.findOne("img") : (c = new CKEDITOR.dom.element("span", b.document), c.setAttributes({
                    ...
                    style: "background:rgba(220,220,220,0.5);background-image:url(" + b.plugins.widget.path +
                        "images/handle.png)"
                }), d = new CKEDITOR.dom.element("img", b.document), d.setAttributes({ "class": "cke_reset cke_widget_drag_handler", "data-cke-widget-drag-handler": "1", src: CKEDITOR.tools.transparentImageData, width: 15, title: b.lang.widget.move, height: 15 }), a.inline && d.setAttribute("draggable", "true"), c.append(d), a.wrapper.append(c));
                ...
                if (!a.inline && (d.on("mousedown", X, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version)) d.on("dragstart", function(a) { a.data.preventDefault(!0) });
        ...
        function X(a) {
            function b() {
                ...
                CKEDITOR.tools.isEmpty(e.visible) || (b = d.getRange(b[0]), this.focus(), f.fire("drop", { dropRange: b, target: b.startContainer }));
            ...
            var m = c.greedySearch(),
                n = CKEDITOR.tools.eventsBuffer(50, function() { p = d.locate(m);
                    k = d.sort(q, 1);
                    k.length && (e.prepare(m, p), e.placeLine(k[0]), e.cleanup()) }),
                p, q;
            h.addClass("cke_widget_dragging");
            g.push(h.on("mousemove", function(a) { q = a.data.$.clientY;
                n.input() }));
        ...
        function N(a, b) {
            ...
            a.on("key", function(b) {
                ...
                if (13 == b) a.edit();
                    ...
                    if (b == CKEDITOR.CTRL + 67 || b == CKEDITOR.CTRL + 88) { y(a, b == CKEDITOR.CTRL + 88);
                        return }
                    if (b in
        ...
        CKEDITOR.plugins.add("widget", {
            ...
            beforeInit: function(a) { a.widgets = new p(a) },
            afterInit: function(a) {
        ...
        p.prototype = {
            ...
            initOn: function(a, b, c) { b ? "string" == typeof b && (b = this.registered[b]) : b = this.registered[a.data("widget")];
                if (!b) return null;
            ...
            initOnAll: function(a) { a = (a || this.editor.editable()).find(".cke_widget_new");
        ...
        g.prototype = {
            ...
            applyStyle: function(a) { A(this, a, 1) },
            checkStyleActive: function(a) { a = B(a);
                var b;
                if (!a) return !1;
                for (; b = a.pop();)
            ...
            edit: function() {
                ...
                this.editor.openDialog(a.dialog, function(a) {
                    var d, e;!1 !== b.fire("dialog", a) && (d = a.on("show", function() { a.setupContent(b) }), e = a.on("ok", function() {
                        ...
                        a.commitContent(b);
                        e.removeListener();
                        d && (b.fire("data", b.data), b.editor.fire("saveSnapshot")) }), a.once("hide", function() { d.removeListener();
                        e.removeListener() })) });
                return !0
            },
            getClasses: function() {
            ...
            _findOneNotNested: function(a) { a = this.wrapper.find(a);
            ...
            removeStyle: function(a) { A(this, a, 0) },
            ...
            updateDragHandlerPosition: function() {
                ...
                c && b.x == c.x && b.y == c.y || (c = a.checkDirty(), a.fire("lockSnapshot"), this.dragHandlerContainer.setStyles({ top: b.y + "px", left: b.x + "px", display: "block" }), a.fire("unlockSnapshot"), !c && a.resetDirty(), this._.dragHandlerOffset =
                    b)
            }
        };
        ...
        q.prototype = CKEDITOR.tools.extend(CKEDITOR.tools.prototypedCopy(CKEDITOR.dom.element.prototype), { setData: function(a) { this._.initialSetData || this.editor.widgets.destroyAll(!1, this);
                ...
                this.setHtml(a);
                this.editor.widgets.initOnAll(this) }, getData: function() {
        ...
        (function() {
            ...
            CKEDITOR.style.addCustomHandler({
                ...
                remove: function(a) { a instanceof CKEDITOR.editor && this.checkApplicable(a.elementPath(), a) && a.widgets.focused.removeStyle(this) },
                checkActive: function(a, b) {
                ...
                toAllowedContentRules: function(a) {
                    ...
                    var b,
                        e = {};
                    if (!a) return null;
                    if (a.styleableElements) { b = this.getClassesArray();
                        if (!b) return null;
